...
<h1 align="center">Gald3r for Void Editor</h1>

<p align="center">
  The <strong>Void Editor edition</strong> of Gald3r -- file-based memory, task management, and
  agent orchestration that runs <strong>inside Void Editor</strong>. Part of the Gald3r framework
...
This is the **Void Editor distribution** of Gald3r. The [`void/`](./void/) folder is a
complete, ready-to-deploy gald3r setup tuned for Void Editor -- drop its contents into your
...
cp -r gald3r_platform_void/void/. /path/to/your/project/
```

Then open the project in Void Editor and type `@g-status` to confirm gald3r loaded.

> The `void/` payload is **additive** -- it drops in gald3r's config + `.gald3r/` state and
